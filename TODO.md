...
- [ ] The highlighting of the user's solutions in the factoring equations is not quite right. If the user enters $t_1 = 9, t_2 = 8$ but the solution is $t_1 = -9, t_2 = 9$, 8 is highlighted in the "correct answer" color, and 9 in the "wrong answer" color. It seems to always be inverted
