...
const dict = {
  ...
  'exercise.roundingSigfigs.prompt': {
    en: 'Round to {0} significant digits.',
    de: 'Runde auf {0} signifikante Stellen.',
  },
  ...
  'exercise.termTransformationsTrivia.whatIsPowerLaw': {
    en: 'What is the {0} power law ({1})?',
    de: 'Was ist das {0} Potenzgesetz ({1})?',
  },
  ...
  'exercise.percent.promptLabelA': { en: 'What is {0}% of {1}?', de: 'Was sind {0}% von {1}?' },
  'exercise.percent.promptLabelB': { en: '{0} is {1}% of what number?', de: '{0} sind {1}% von welcher Zahl?' },
  'exercise.percent.promptLabelC': { en: 'What percentage of {1} is {0}?', de: 'Wie viel Prozent von {1} sind {0}?' },
  'exercise.percent.promptLabelD': {
    en: '{0} pieces cost CHF {1}. How much for {2} pieces?',
    de: '{0} Stück kosten CHF {1}. Was kosten {2} Stück?',
  },
  'exercise.percent.promptLabelE': {
